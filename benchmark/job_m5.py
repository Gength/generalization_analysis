...
ap.add_argument("--eval-only", action="store_true"); ap.add_argument("--quick", action="store_true"); ap.add_argument("--tf2", action="store_true")
args = ap.parse_args()
...
run(args.dataset, workdir, output_dir, quick=args.quick, tf2=args.tf2, eval_only=args.eval_only, miners=args.miners)
