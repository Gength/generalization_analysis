...
| M6 | Bootstrap Gen (Entropia -bgen) | Java (Entropia 1.7) | ✅ D1 complete | `bash benchmark/m6.sh` |
...
XES parser triggers a NullPointerException on BPI2013 Incidents when using the
default `k=2` subtrace length. A minimal workaround of `k=1` is used for D2
instead. Since D2 has only 4 real activities, `k=1` vs `k=2` makes negligible
difference to the resulting precision/recall values.
...
| Alpha+ | 0.6033 | 0.5523 | 0.6299 | 0.6358 | 0.6512 | 0.6512 | 0.7591 | 0.9189 | 29.87 | 0.5617 | **0.1857** | 0.7500 | 0.8293 | 0.7753 | 0.3820 |
| Heuristics | 0.8733 | 0.8262 | 0.8403 | 0.8379 | 0.8457 | 0.8457 | 0.8787 | 0.8414 | 29.87 | 0.7460 | **0.3513** | 0.9989 | 0.9024 | 0.8700 | 0.5024 |
| Heuristics_Strict | 0.8936 | 0.8456 | 0.8567 | 0.8531 | 0.8640 | 0.8640 | 0.9174 | 0.9004 | 29.87 | 0.7044 | **0.3322** | 0.9988 | 0.9329 | 0.9175 | 0.9175 |
| Inductive_Strict | 0.9747 | 0.9407 | 0.9593 | 0.9590 | 0.9613 | 0.9613 | 0.9838 | 0.9025 | 29.87 | 0.5347 | **0.2257** | 0.7456 | 0.9999 | 1.0000 | 0.7667 |
| Inductive_Infrequent | 0.9122 | 0.8872 | 0.9182 | 0.9208 | 0.9310 | 0.9310 | 0.9723 | 0.8799 | 29.87 | 0.7506 | **0.2982** | 0.7500 | 0.9846 | 0.9813 | 0.6930 |
| Flower | 1.0000 | 1.0000 | 1.0000 | 1.0000 | 1.0000 | 1.0000 | 1.0000 | 0.9132 | 29.87 | 0.3967 | **0.1806** | 0.8208 | 1.0000 | 1.0000 | 1.0000 |
| Trace_Filtered | 0.5620 | 0.4956 | 0.5173 | 0.5106 | 0.5085 | 0.5085 | 0.5687 | 0.0376 | 29.87 | 0.0000 | **0.4565** | 1.0000 | 0.6411 | 0.6058 | 0.2796 |
...
>
> **Trace_Filtered row**: M1a–M1g + R1 from v2 configs (`configs_v2/`). M2/R3 computed 2026-06-13 via `benchmark/run_trace_filtered_externals.py`. M3 is DFG-based (same 29.87 as all miners). M6 (Entropia -bgen, 5 reps) computed 2026-06-18 via per-miner DFG JSON conversion + `-bgen` on Entropia 1.7. See [M6 Implementation Note](#m6-implementation-note). M7 (SpeciAL4PM C1 ratio) computed 2026-06-13 via `benchmark/run_m6_m7_trace_filtered.py`. R2 (sampled LOVO, 50/846 variants, seed 42) via `benchmark/run_r2_trace_filtered.py`. **M5 (AVATAR) on Trace_Filtered**: 0.0000 — strongest memorization pole signal across all methods. Reuses existing GAN checkpoint suffix=4981. Run via: `uv run python benchmark/docker/run_avatar.py --miners Trace_Filtered --eval-only`.
>
...
| Miner | M1a | M1b | M1c | M1d | M1e | M1f | M1g | M2* | M3\*\* | M5\*\*\* | M6 | M7 | R1 | R2 | R3 |
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| Trace_Filtered | 0.6335 | 0.5950 | 0.6052 | 0.5469 | 0.5456 | 0.5456 | 0.6000 | 0.0605 | 0.0000 | 0.0000 | **0.7876** | 1.0000 | 0.6529 | 0.6798 | 0.4995 |
| Alpha | 0.3129 | 0.3830 | 0.3665 | 0.2817 | 0.2803 | 0.2803 | 0.2572 | 0.8825 | 0.0000 | 0.1328 | **0.0000** | 1.0000 | 0.2150 | 0.1402 | 0.4429 |
| Alpha+ | 0.5866 | 0.5178 | 0.5400 | 0.5967 | 0.5988 | 0.5988 | 0.6301 | 0.8452 | 0.0000 | 0.9793 | **0.5821** | 0.8140 | 0.6979 | 0.7931 | 0.6896 |
| Heuristics | 0.9969 | 0.9640 | 0.9694 | 0.9527 | 0.9529 | 0.9529 | 0.9935 | 0.9024 | 0.0000 | 0.9349 | **0.7840** | 0.9803 | 0.9956 | 0.9904 | 0.8106 |
| Heuristics_Strict | 0.9990 | 0.9710 | 0.9776 | 0.9661 | 0.9664 | 0.9664 | 0.9978 | 0.9295 | 0.0000 | 0.8338 | **0.7620** | 0.9787 | 0.9983 | 0.9974 | 0.9243 |
| Inductive_Strict | 1.0000 | 0.9997 | 0.9997 | 0.9989 | 0.9988 | 0.9988 | 1.0000 | 0.8711 | 0.0000 | 0.7404 | **0.5979** | 1.0000 | 1.0000 | 1.0000 | 0.9425 |
| Inductive_Infrequent | 0.9960 | 0.9729 | 0.9745 | 0.9587 | 0.9598 | 0.9598 | 0.9907 | 0.9887 | 0.0000 | 0.7403 | **0.8468** | 1.0000 | 0.9881 | 0.9864 | 0.8474 |
| Flower | 1.0000 | 1.0000 | 1.0000 | 1.0000 | 1.0000 | 1.0000 | 1.0000 | 0.8825 | 0.0000 | 0.7404 | **0.5619** | 0.9372 | 1.0000 | 1.0000 | 1.0000 |
...
>
> **M6 (\*\*\*\*)**: Bootstrap Generalization with Entropia `-bgen` scoring (v2 methodology). Uses `k=1` instead of `k=2` due to a JAR bug (NullPointerException) on BPI2013 Incidents XES parsing at `k=2`. See [M6 Implementation Note](#m6-implementation-note) for details and the D2-specific workaround.
>
